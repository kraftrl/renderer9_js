...
// row 0
models[0][0] = new ObjSimpleModel("assets/great_rhombicosidodecahedron.obj");
...
models[1][1] = new ObjSimpleModel("assets/horse.obj");
ModelShading.setColor(models[1][1], Color.Pink);

models[1][2] = new GRSModel("assets/grs/vinci.grs");
ModelShading.setColor(models[1][2], Color.Blue);

models[1][3] = new Tetrahedron();
ModelShading.setColor(models[1][3], Color.Cyan);

models[1][4] = new ObjSimpleModel("assets/small_rhombicosidodecahedron.obj");
...
models[2][1] = new GRSModel("assets/grs/bronto.grs");
